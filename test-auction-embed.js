// // test-auction-embed.js
// require("dotenv").config();

// const sendAuctionAnnouncementTest = async ({
//   type,
//   auction,
//   winnerName,
//   winningBid,
...
//       console.log(
//         `✅ [${type}] Message sent successfully! Message ID: ${data.id}`,
//       );
//     }
//   } catch (err) {
...
// // Run test for START, then test for END
// (async () => {
//   console.log("🚀 Testing START announcement...");
//   await sendAuctionAnnouncementTest({
//     type: "START",
//     auction: {
//       itemName: "Custom Clan Role & Banner",
//       startingBid: 2500,
//       description: "Exclusive top tier role with custom hoist color and icon.",
//     },
//   });

//   console.log("🚀 Testing END announcement...");
//   await sendAuctionAnnouncementTest({
//     type: "END",
//     auction: {
//       itemName: "Custom Clan Role & Banner",
//     },
//     winnerName: "GhostRider",
//     winningBid: 14500,
//   });
// })();
